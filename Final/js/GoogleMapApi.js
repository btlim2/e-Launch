...
// zoom the map in on the city.
    ...
    function onPlaceChanged() {
      ...
      if(ser != "" && autoCom !=""){
          $("#sectionMap").removeClass("col-md-12");
          $("#sectionMap").addClass("col-md-6");
          $("#sectionListing").removeClass("col-md-0");
          $("#sectionListing").addClass("col-md-6");
          $("#listing").animate({width:"560px"});
          $("#map").animate({width:"560px"})
      }
